...
Mostly extracted from https://github.com/rpautrat/SuperPoint/tree/master/superpoint/datasets/utils """
...
def additive_gaussian_noise(img, keypoints, seed=None, std=(5, 65)):
...
def random_crop(img, keypoints, random_state=None, min_crop_ratio=0.7):
